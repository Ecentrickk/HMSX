...
export const DeathCertificatePDF = ({ data }: { data: any }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <Text style={styles.title}>Certificate of Death</Text>
      ...
      <View style={{ paddingHorizontal: 20 }}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>{data.patient.uhid || 'N/A'}</Text>
        </View>
        <View style={styles.row}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>{new Date(data.patient.dateOfBirth).toLocaleDateString()}</Text>
        </View>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>{new Date(data.timeOfDeath).toLocaleTimeString()}</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.label}>Place of Death:</Text>
          <Text style={styles.value}>{HOSPITAL_BRANDING.name}</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.label}>Cause of Death:</Text>
          <Text style={styles.value}>{data.causeOfDeath || 'Pending Investigation'}</Text>
        </View>
        <View style={styles.row}>
